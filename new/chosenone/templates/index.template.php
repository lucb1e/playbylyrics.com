<?php 
	...
	if ($lyricsWereEntered) {
		if (count($ytData->data->items) <= $youtubeResultNum || $videoid == "") {
			...
			echo "<iframe id='playerfrm' src='http://www.youtube.com/v/" . $videoid . "&autoplay=1' width='600' height='400'></iframe><br/>";
			echo "<br/>";
...
<div class="searchBlock">
	<form method="get" action="./" onsubmit="onSubmit();">
		<input type="text" name="lyrics" placeholder="Lyrics" value='<?php echo str_replace("'", "&#39;", $_GET["lyrics"]); ?>'/>
