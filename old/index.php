<?php 
	...
	function getGoogle($str, $resultNum = 0, $tillResult = 1) {
		...
		if (!$fp) {
			...
			fwrite($fid, date("r") . " $_SERVER[REMOTE_ADDR] www.google.com:80 unreachable within 2 seconds.<br>\n");
			fclose($fid);
			die("Internal error. Please try again (reload the page).\n<br/>\n<br/>\nYou might see these errors more often lately. Since I have to rely on Youtube to get the right video, this is totally out of my control. I'm really sorry :(");
		}
	...
	<body>
		<div style="width: 535px; margin: 0 auto 0 auto; text-align: center; position: relative;">
					...
					if ($lyricsWereEntered) {
						...
						function loopIt() {
							...
							document.getElementById("playerfrm").outerHTML = "<div class='resumeDiv' style='width: 480px; height: 320px; margin: 0 auto 0 auto;'><br/><br/><br/>"
							                                               + "You chose to auto-replay the video. I've hid it so<br/>"
							                                               + "that it doesn't continue playing here.<br/>"
							                                               + "<a href='javascript: restoreIframe();'>Restore video</a><br/><br/>"
			...
			<span class='light copyright'>
				&copy; 2012 <a href='./' class='light'>PlayByLyrics.com</a> - <a href='about.htm' class='light underlined'>About</a> - <a href='terms.htm' class='light underlined'>Legal &amp; Privacy</a> - <a href='feedback.php' class='light underlined'>Feedback</a>
			</span>
		</div>
